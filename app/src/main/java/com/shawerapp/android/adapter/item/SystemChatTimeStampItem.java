...
public class SystemChatTimeStampItem
    extends AbstractFlexibleItem<SystemChatTimeStampItem.ViewHolder> {

  private final String timeStampMessage;

  public SystemChatTimeStampItem(String timeStampMessage) {
  ...
  @Override public int getLayoutRes() {
    return R.layout.item_system_chat_time_stamp;
  }
